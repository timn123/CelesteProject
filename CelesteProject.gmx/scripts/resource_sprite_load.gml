...
stderr_write("Adding Sprite from '" + string(fname) + "' with origin (" + string(argument1) + ", " + string(argument2) + ") with ID " + string(global.resource_sprite_count));
...
{
    stderr_error("Sprite '" + string(fname) + "' did not load properly.");
